...
class TestCalculateAge:
    def test_valid_age_calculation(self):
        ...
        df = pd.DataFrame({"dob": ["1990-05-15", "1985-12-01"], "year": [2020, 2025]})
    ...
    def test_missing_dob_column(self):
        ...
        df = pd.DataFrame({"name": ["Alice", "Bob"], "year": [2020, 2020]})
    ...
    def test_short_dob_strings(self):
        ...
        df = pd.DataFrame({"dob": ["1990", "90-05", ""], "year": [2020, 2020, 2020]})
