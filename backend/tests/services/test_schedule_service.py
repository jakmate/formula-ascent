...
class TestScheduleService:
        ...
        return [
            {
                ...
                "location": "Australia",
                "sessions": {
                    "practice": {"start": "2025-03-14T01:00:00", "end": "2025-03-14T01:45:00"},
                    "qualifying": {"start": "2025-03-14T04:50:00", "end": "2025-03-14T05:20:00"},
                    "sprint": {"start": "2025-03-15T01:25:00", "end": "2025-03-15T02:05:00"},
                    "race": {"start": "2025-03-15T22:55:00", "end": "2025-03-15T23:40:00"},
                },
            },
            {
                "round": 2,
                ...
                "location": "Bahrain",
                "sessions": {
                    "practice": {"start": "2025-04-11T11:00:00", "end": "2025-04-11T11:45:00"},
                    "qualifying": {"start": "2025-04-11T14:55:00", "end": "2025-04-11T15:25:00"},
                    "sprint": {"start": "2025-04-12T11:15:00", "end": "2025-04-12T11:55:00"},
                    "race": {"start": "2025-04-13T07:40:00", "end": "2025-04-13T08:25:00"},
                },
            },
        ]
        ...
        return [
            {
                ...
                "sessions": {
                    ...
                    "race": {"start": "2025-08-03T15:00:00", "end": "2025-08-03T16:00:00"},
                },
            }
        ]
            ...
            with patch("builtins.open", mock_open(read_data=json.dumps(sample_schedule_data))):
                with patch.object(schedule_service, "_convert_schedule_timezone") as mock_convert:
                    ...
                    await schedule_service.get_series_schedule(
                        ScheduleRequest(
                            series="f1", timezone="America/New_York", x_timezone="Europe/London"
                        )
                    )
        ...
        tbc_schedule = [
            {
                ...
                "location": "Test",
                "sessions": {
                    "practice": {"start": "2030-08-01", "time": "TBC"},  # Date-only format for TBC
        ...
        test_schedule = [
            {
                ...
                "sessions": {
                    ...
                    "practice": {"start": "2030-03-15T10:00:00"},  # Earlier - should be selected
    ...
    async def test_get_next_race_fallback_skips_invalid_dates(self, schedule_service):
        ...
        schedule = [
            {
                ...
                "name": "Race A",
                "location": "A",
                "sessions": {"practice": {"start": "A_practice"}, "race": {"start": "A_race"}},
            },
            {
                "round": 2,
                "name": "Race B",
                "location": "B",
                "sessions": {"practice": {"start": "B_practice"}, "race": {"start": "B_race"}},
            },
        ]
        ...
        ), patch.object(ScheduleService, "_parse_datetime", side_effect=fake_parse), patch(
