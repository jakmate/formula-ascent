...
class TestDataService:
    ...
    @pytest.mark.asyncio
    async def test_load_current_data_fallback_to_max_year(
        self,
        mock_engineer,
        mock_target,
        mock_quali_features,
    ...
    @patch("app.core.predictor.engineer_features")
    @pytest.mark.asyncio
    async def test_load_current_data_no_drivers_available(
        self,
        mock_engineer,
        mock_target,
        mock_quali_features,
    ...
    @pytest.mark.asyncio
    async def test_initialize_system_full_flow(
        self,
        mock_logger,
    ...
    @patch("app.services.data_service.LOGGER")
    @pytest.mark.asyncio
    async def test_initialize_system_no_historical_data(
        self,
        mock_logger,
        mock_pred_service_class,
        mock_model_service_class,
    ...
    @patch("app.services.data_service.LOGGER")
    @pytest.mark.asyncio
    async def test_initialize_system_exception_handling(
        self, mock_logger, mock_load_data, data_service
    ):
    ...
    @patch("app.services.data_service.LOGGER")
    @pytest.mark.asyncio
    async def test_load_current_data_cache_miss(
        self,
        mock_logger,
        mock_time,
        mock_load_data,
